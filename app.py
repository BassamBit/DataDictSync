...
# ========= Column mapping =========
# الترتيب الفعلي في الجدول:
# col[0]=Code, col[1]=EN Term+Def, col[2]=Owner EN, col[3]=Class EN,
# col[4]=Personal Data EN, col[5]=Personal Data AR, col[6]=Class AR,
# col[7]=Owner AR, col[8]=AR Term+Def
...
# Reversed: مرآة للترتيب الطبيعي (الأعمدة من اليمين لليسار)
REVERSED_MAP = {
    8: "code",
    7: "en_name_def",
    6: "owner_en",
